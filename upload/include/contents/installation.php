...
// Installation Datenschutzerklaerung
...
$modulby = 'Maretz.eu';
$script_name = 'Datenschutzerklärung';
$script_vers = '1.0';
$ilch_vers = '1.1';
$ilch_update = 'P';
$erfolg = '';
...
if (!isset($_POST['do'])) {
            ...
            <tr class="Cmite">
                <td align="left">
                    ...
                    <div style="margin-left:30px; text-align:left;">
                        ...
                        Sollte auch bei &auml;lteren Versionen von 1.1 laufen.<br>
                    </div>
                    <br />
                    <hr />
                    <br />
                    <div style="margin-left:30px; text-align:left;">
                        ...
                        Machen Sie zuerst ein <a href="admin.php?backup" target="_blank" style="font-weight:bold;">Backup</a> Ihrer Datenbank!<br />
                        <br />
                    </div>
                </td>
            </tr>
    ...
    $check_dc = db_query("SHOW TABLES LIKE 'prefix_datenschutzerklaerung'");
    if (db_num_rows($check_dc)) {
        echo "<table width=\"97%\" border=\"0\" cellpadding=\"1\" cellspacing=\"3\" class=\"border\">
  <tr>
<td class=\"Chead\" align=\"center\" style=\"padding:8px\"><h2>Datenschutzerklärung <small><a href=\"http://www.maretz.eu\">by Maretz.eu</a></small></h2></td>
</tr><tr>
<td class=\"Cmite\" align=\"center\"><b>Installation abgebrochen!</b><br>Das Modul wurde bereits installiert!</td>
    </tr>
    <tr>
<td class=\"Cnorm\" align=\"center\"><a href=\"index.php\">Zur Startseite</a></td>
</tr>
    </table>";
    } else {
        $error = '';
...
// Ausgabe
        ...
        <table width="97%" class="border" border="0" cellspacing="1" cellpadding="3" align="center">
            ...
            <tr class="Cnorm" align="center">
                <td><h2>Install abgeschlossen</td>
            </tr>
            <tr class="Cmite">
            ...
            <tr class="Chead">
                <td colspan="3" align="center">
                    <button onclick="javascript:window.location.href = 'index.php';">Auf die Startseite</button>&nbsp;&nbsp;&nbsp;<button onclick="javascript:window.location.href = 'index.php?datenschutz';">Datenschutz Seite aufrufen</button>
                </td>
            </tr>
        </table>
        </td>
